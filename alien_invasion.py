...
class AlienInvasion:
    ...
    def _check_bullet_alien_colission(self):
        ...
        # Check for bullets that have hit any alien
    ...
    def _create_fleet(self):
        ...
        # Calculate the number of rows (height) of aliens that can fit the scrn
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # Treat it the same as the ship got hit
                self._ship_hit()
                break

    def _check_fleet_edges(self):
        """Respond appriopetly if any alien hit the edge"""
        for alien in self.aliens.sprites():
